  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full p-3 mx-4 min-h-7/10 max-h-9/10 md:w-[650px] md:h-3/4 bg-[#2f2f2f] rounded-lg shadow-lg border border-[#3a3a3a] flex flex-col  overflow-y-auto dark-scrollbar md:p-3 gap-2 md:gap-2">
        ...
        {/* Label and Input */}
        <div className="w- border-b border-[#3a3a3a] pb-3">
          ...
          <div className="flex items-center gap-4">
            <input
              ...
              className="text-xs md:!text-sm w-full px-4 py-2 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              onClick={handleSearch}
              className="!text-xs md:!text-sm bg-blue-600 hover:bg-blue-700 text-white md:px-4 px-3 py-2 md:py-1 items-center rounded-md flex items-center gap-1 transition"
            >
        ...
        {/* Results Section */}
        <div className="mt-2 text-white flex flex-col flex-1 rounded-md p-4 overflow-y-auto dark-scrollbar md:p-2 gap-5 !text-xs md:text-sm md:!text-gray-400">
